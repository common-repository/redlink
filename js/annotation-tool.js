function Annotator(options) {
    ...
    var _options = {
        ...
        text:"Redlink GmbH is a start-up launched in March 2013 headquartered in Austria and delivers on the promise of providing enterprise-grade Content Enrichment and Linked Data platform that supports a broad set of mission-critical and real-time production uses.Redlink and its core team (John Pereira, Sebastian Schaffert, Thomas Kurz, Jakob Frank, Rupert Westenthaler, Sergio Fernández, Aingaran Pillai, Andrea Volpini, David Riccitelli and Rafa Haro) are committed to the development of Apache Stanbol and Apache Marmotta and to the continuous growth of these projects as well as to their integration with Apache Solr.",
